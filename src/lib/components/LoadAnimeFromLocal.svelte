...
<button class="drawer-button" on:click={handleClick}>
	<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640" fill="#e0e0e0" stroke="#e0e0e0"
...
<style>
	...
	.drawer-button svg {
		width: 28px;
		height: 28px;
		fill: white; /* makes it inherit text color */
	}
