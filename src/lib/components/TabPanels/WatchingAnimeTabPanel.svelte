<script>
	let { watchingAnime = $bindable() } = $props();
	let trendingAnimePageNo = 1;

	const loadWatchingAnime = async () => {
		trendingAnimePageNo++;
		console.warn("Load watching anime not yet implemented...");
	};
</script>

<div class="tab-panel">
	<div class="card-display">
		{#each watchingAnime as anime, i (i)}
			<div class="card">
	...
	<button class="load-more-button" onclick={loadWatchingAnime}>Load more</button>
</div>
